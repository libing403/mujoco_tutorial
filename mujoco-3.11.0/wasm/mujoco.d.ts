...
export interface mjrIndexTypeValue<T extends number> {
  value: T;
}
export type mjrIndexType = mjrIndexTypeValue<0>|mjrIndexTypeValue<1>;

export interface mjrMeshPrimitiveTypeValue<T extends number> {
  value: T;
}
export type mjrMeshPrimitiveType = mjrMeshPrimitiveTypeValue<0>|mjrMeshPrimitiveTypeValue<1>;

export interface mjrPixelFormatValue<T extends number> {
  value: T;
}
export type mjrPixelFormat = mjrPixelFormatValue<0>|mjrPixelFormatValue<1>|mjrPixelFormatValue<2>|mjrPixelFormatValue<3>|mjrPixelFormatValue<4>|mjrPixelFormatValue<5>|mjrPixelFormatValue<6>;

export interface mjrVertexAttributeTypeValue<T extends number> {
  value: T;
}
export type mjrVertexAttributeType = mjrVertexAttributeTypeValue<0>|mjrVertexAttributeTypeValue<1>|mjrVertexAttributeTypeValue<2>|mjrVertexAttributeTypeValue<3>;

export interface mjrVertexAttributeUsageValue<T extends number> {
  value: T;
}
export type mjrVertexAttributeUsage = mjrVertexAttributeUsageValue<0>|mjrVertexAttributeUsageValue<1>|mjrVertexAttributeUsageValue<2>|mjrVertexAttributeUsageValue<3>|mjrVertexAttributeUsageValue<4>;
...
export type mjtBias = mjtBiasValue<0>|mjtBiasValue<1>|mjtBiasValue<2>|mjtBiasValue<3>|mjtBiasValue<4>|mjtBiasValue<5>;
...
export interface mjtConflictValue<T extends number> {
  value: T;
}
export type mjtConflict = mjtConflictValue<0>|mjtConflictValue<1>|mjtConflictValue<2>;
...
export interface mjtCtrlChartValue<T extends number> {
  value: T;
}
export type mjtCtrlChart = mjtCtrlChartValue<1>|mjtCtrlChartValue<2>;
...
export type mjtGain = mjtGainValue<0>|mjtGainValue<1>|mjtGainValue<2>|mjtGainValue<3>|mjtGainValue<4>|mjtGainValue<5>;
...
export interface mjtLogLevelValue<T extends number> {
  value: T;
}
export type mjtLogLevel = mjtLogLevelValue<0>|mjtLogLevelValue<1>|mjtLogLevelValue<2>|mjtLogLevelValue<3>;

export interface mjtLogTopicValue<T extends number> {
  value: T;
}
export type mjtLogTopic = mjtLogTopicValue<0>|mjtLogTopicValue<1>|mjtLogTopicValue<2>|mjtLogTopicValue<3>|mjtLogTopicValue<3>;
...
export type mjtMouse = mjtMouseValue<0>|mjtMouseValue<1>|mjtMouseValue<2>|mjtMouseValue<3>|mjtMouseValue<4>|mjtMouseValue<5>|mjtMouseValue<6>|mjtMouseValue<7>|mjtMouseValue<8>|mjtMouseValue<9>;
...
export type mjtTrn = mjtTrnValue<0>|mjtTrnValue<1>|mjtTrnValue<2>|mjtTrnValue<3>|mjtTrnValue<4>|mjtTrnValue<5>|mjtTrnValue<6>|mjtTrnValue<1000>;
...
export interface MjData extends ClassHandle {
  ...
  readonly efm_K_colind: any;
  readonly efm_K_rowadr: any;
  readonly efm_K_rownnz: any;
  readonly efm_K_val: any;
  readonly efm_L: any;
  readonly efm_L_colind: any;
  readonly efm_L_rowadr: any;
  readonly efm_L_rownnz: any;
  efm_active: number;
  readonly efm_c: any;
  readonly efm_dofid: any;
  readonly energy: any;
...
export interface MjLogConfig extends ClassHandle {
  readonly logfile: any;
  logto_console: boolean;
  logto_file: boolean;
  topics: number;
  copy(): MjLogConfig;
}

export interface MjLogMessage extends ClassHandle {
...
export interface MjModel extends ClassHandle {
  ...
  readonly actuator_ctrladr: any;
  readonly actuator_ctrllimited: any;
  readonly actuator_ctrlnum: any;
  readonly actuator_ctrlrange: any;
  readonly actuator_ctrlspec: any;
  ...
  readonly actuator_outadr: any;
  readonly actuator_outnum: any;
  ...
  readonly efm0_L: any;
  readonly efm0_L_colind: any;
  readonly efm0_L_rowadr: any;
  readonly efm0_L_rownnz: any;
  readonly efm0_dofid: any;
...
export interface MjsActuator extends ClassHandle {
  actdim: number;
  actearly: boolean;
  actlimited: mjtLimited;
  readonly actrange: any;
  armature: number;
  readonly biasprm: any;
  biastype: mjtBias;
  cranklength: number;
  ctrllimited: mjtLimited;
...
export interface MjsAuthored extends ClassHandle {
  disableactuator: number;
  disableflags: number;
  enableflags: number;
  option: bigint;
  visual_global: bigint;
  visual_headlight: bigint;
  visual_map: bigint;
  visual_quality: bigint;
  visual_rgba: bigint;
  visual_scale: bigint;
}
...
interface EmbindModule {
  mjrIndexType: {mjINDEX_TYPE_U16: mjrIndexTypeValue<0>, mjINDEX_TYPE_U32: mjrIndexTypeValue<1>};
  mjrMeshPrimitiveType: {mjMESH_PRIMITIVE_TYPE_TRIANGLES: mjrMeshPrimitiveTypeValue<0>, mjMESH_PRIMITIVE_TYPE_LINES: mjrMeshPrimitiveTypeValue<1>};
  mjrPixelFormat: {mjPIXEL_FORMAT_UNKNOWN: mjrPixelFormatValue<0>, mjPIXEL_FORMAT_R8: mjrPixelFormatValue<1>, mjPIXEL_FORMAT_RGB8: mjrPixelFormatValue<2>, mjPIXEL_FORMAT_RGBA8: mjrPixelFormatValue<3>, mjPIXEL_FORMAT_R32F: mjrPixelFormatValue<4>, mjPIXEL_FORMAT_DEPTH32F: mjrPixelFormatValue<5>, mjPIXEL_FORMAT_KTX: mjrPixelFormatValue<6>};
  mjrVertexAttributeType: {mjVERTEX_ATTRIBUTE_TYPE_FLOAT2: mjrVertexAttributeTypeValue<0>, mjVERTEX_ATTRIBUTE_TYPE_FLOAT3: mjrVertexAttributeTypeValue<1>, mjVERTEX_ATTRIBUTE_TYPE_FLOAT4: mjrVertexAttributeTypeValue<2>, mjVERTEX_ATTRIBUTE_TYPE_UBYTE4: mjrVertexAttributeTypeValue<3>};
  mjrVertexAttributeUsage: {mjVERTEX_ATTRIBUTE_USAGE_POSITION: mjrVertexAttributeUsageValue<0>, mjVERTEX_ATTRIBUTE_USAGE_NORMAL: mjrVertexAttributeUsageValue<1>, mjVERTEX_ATTRIBUTE_USAGE_TANGENTS: mjrVertexAttributeUsageValue<2>, mjVERTEX_ATTRIBUTE_USAGE_UV: mjrVertexAttributeUsageValue<3>, mjVERTEX_ATTRIBUTE_USAGE_COLOR: mjrVertexAttributeUsageValue<4>};
  ...
  mjtBias: {mjBIAS_NONE: mjtBiasValue<0>, mjBIAS_AFFINE: mjtBiasValue<1>, mjBIAS_MUSCLE: mjtBiasValue<2>, mjBIAS_DCMOTOR: mjtBiasValue<3>, mjBIAS_SO3: mjtBiasValue<4>, mjBIAS_USER: mjtBiasValue<5>};
  ...
  mjtConflict: {mjCONFLICT_WARNING: mjtConflictValue<0>, mjCONFLICT_MERGE: mjtConflictValue<1>, mjCONFLICT_ERROR: mjtConflictValue<2>};
  ...
  mjtCtrlChart: {mjCHART_EXPMAP: mjtCtrlChartValue<1>, mjCHART_QUAT: mjtCtrlChartValue<2>};
  ...
  mjtGain: {mjGAIN_FIXED: mjtGainValue<0>, mjGAIN_AFFINE: mjtGainValue<1>, mjGAIN_MUSCLE: mjtGainValue<2>, mjGAIN_DCMOTOR: mjtGainValue<3>, mjGAIN_SO3: mjtGainValue<4>, mjGAIN_USER: mjtGainValue<5>};
  ...
  mjtLogLevel: {mjLOG_DEBUG: mjtLogLevelValue<0>, mjLOG_INFO: mjtLogLevelValue<1>, mjLOG_WARNING: mjtLogLevelValue<2>, mjLOG_ERROR: mjtLogLevelValue<3>};
  mjtLogTopic: {mjTOPIC_NONE: mjtLogTopicValue<0>, mjTOPIC_TIME_STP: mjtLogTopicValue<1>, mjTOPIC_TIME_CMP: mjtLogTopicValue<2>, mjTOPIC_SLEEP: mjtLogTopicValue<3>, mjNTOPIC: mjtLogTopicValue<3>};
  ...
  mjtMouse: {mjMOUSE_NONE: mjtMouseValue<0>, mjMOUSE_ROTATE_V: mjtMouseValue<1>, mjMOUSE_ROTATE_H: mjtMouseValue<2>, mjMOUSE_MOVE_V: mjtMouseValue<3>, mjMOUSE_MOVE_H: mjtMouseValue<4>, mjMOUSE_ZOOM: mjtMouseValue<5>, mjMOUSE_MOVE_V_REL: mjtMouseValue<6>, mjMOUSE_MOVE_H_REL: mjtMouseValue<7>, mjMOUSE_TURN_V: mjtMouseValue<8>, mjMOUSE_TURN_H: mjtMouseValue<9>};
  ...
  mjtTrn: {mjTRN_JOINT: mjtTrnValue<0>, mjTRN_JOINTINPARENT: mjtTrnValue<1>, mjTRN_SLIDERCRANK: mjtTrnValue<2>, mjTRN_TENDON: mjtTrnValue<3>, mjTRN_SITE: mjtTrnValue<4>, mjTRN_BODY: mjtTrnValue<5>, mjTRN_SO3: mjtTrnValue<6>, mjTRN_UNDEFINED: mjtTrnValue<1000>};
  ...
  mj_actuatorInputName(_0: MjModel, _1: number, _2: number): string;
  ...
  mj_fullM(_0: MjModel, _1: MjData, _2: any): void;
  ...
  mj_resetCtrl(_0: MjModel, _1: MjData): void;
  ...
  mjs_getWarning(_0: MjSpec, _1: number): string;
  ...
  mjs_numWarnings(_0: MjSpec): number;
  ...
  mjs_setToOrientation(_0: MjsActuator, _1: number, _2: any, _3: any, _4: number): string;
  ...
  mju_message(_0: MjLogMessage): void;
  ...
  mju_setLogConfig(_0: MjLogConfig): void;
  ...
  mju_threadpool(_0: MjData, _1: number): void;
  ...
  mjv_moveCamera(_0: MjModel, _1: number, _2: number, _3: number, _4: MjvCamera): void;
  ...
  parseXMLString(_0: EmbindString, _1: MjVFS): MjSpec;
  ...
  mju_info(_0: number, _1: string): void;
  mjs_makeFlex(_0: MjsBody, _1: string, _2: string|null, _3: number, _4: string|null, _5: number[], _6: number[], _7: number[], _8: number[], _9: number, _10: number, _11: number, _12: number, _13: number, _14: number, _15: number, _16: number[], _17: number[], _18: number[], _19: string|null, _20: MjVFS): MjsFlex | undefined;
