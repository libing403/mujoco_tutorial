...
<!-- EMBEDDED_EXAMPLE_BEGIN: 35_transition_fd -->
### 可视化运行与效果
...
![35_transition_fd 实验运行效果](../assets/experiments/35_transition_fd.png)

*35_transition_fd 的真实 MuJoCo 原生渲染结果。*

### 实验完整源码

以下文件与 `examples/35_transition_fd/` 中可直接编译的版本一致。

#### 模型文件：`model.xml`

```xml
<mujoco model="transition finite difference">
  <option timestep="0.002" integrator="implicitfast"/>
  <worldbody>
    <body>
      <joint name="hinge" axis="0 1 0" damping=".1" armature=".02"/>
...
project(35_transition_fd LANGUAGES CXX)
...
```
<!-- EMBEDDED_EXAMPLE_END: 35_transition_fd -->
